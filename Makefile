...
CXXFLAGS = -O3 -std=c++11 -g -I$(OMPROOT) -I$(MKLROOT)/include  -Wl,--start-group ${MKLROOT}/lib/intel64/libmkl_intel_lp64.a ${MKLROOT}/lib/intel64/libmkl_intel_thread.a ${MKLROOT}/lib/intel64/libmkl_core.a -Wl,--end-group -liomp5 -lpthread -lm -ldl -mkl -qopenmp
LDFLAGS = -fopenmp
