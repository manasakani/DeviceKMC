...
template 
void solve_own_generic_mv<own_mv::distributed_mv_point_to_point1>(
    double *data_h,
    int *col_indices_h,
    int *row_indptr_h,
    double *rhs_h,
    ...
    double *time_taken);
template 
void solve_own_generic_mv<own_mv::distributed_mv_point_to_point2>(
    double *data_h,
    int *col_indices_h,
    int *row_indptr_h,
    double *rhs_h,
    ...
    double *time_taken);
template 
void solve_own_generic_mv<own_mv::distributed_mv_point_to_point3>(
    double *data_h,
    int *col_indices_h,
    int *row_indptr_h,
    double *rhs_h,
    ...
    double *time_taken);
template 
void solve_own_generic_mv<own_mv::distributed_mv_custom_datatype1>(
    double *data_h,
    int *col_indices_h,
    int *row_indptr_h,
    double *rhs_h,
    ...
    double *time_taken);
template 
void solve_own_generic_mv<own_mv::distributed_mv_custom_datatype2>(
    double *data_h,
    int *col_indices_h,
    int *row_indptr_h,
    double *rhs_h,
    ...
    double *time_taken);
template 
void solve_own_generic_mv<own_mv::distributed_mv_gpu_packing1>(
    double *data_h,
    int *col_indices_h,
    int *row_indptr_h,
    double *rhs_h,
    ...
    double *time_taken);
template 
void solve_own_generic_mv<own_mv::distributed_mv_gpu_packing2>(
    double *data_h,
    int *col_indices_h,
    int *row_indptr_h,
    double *rhs_h,
    ...
    double *time_taken);
template 
void solve_own_generic_mv<own_mv::distributed_mv_gpu_packing3>(
    double *data_h,
    int *col_indices_h,
    int *row_indptr_h,
    double *rhs_h,
    ...
    double *time_taken);
template 
void solve_own_generic_mv<own_mv::distributed_mv_gpu_packing4>(
    double *data_h,
    int *col_indices_h,
    int *row_indptr_h,
    double *rhs_h,
