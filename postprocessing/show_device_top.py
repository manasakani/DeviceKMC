...
def main():
    ...
    # top contact (5nm):
    x_start1, x_end1 = 0.868194/10, 24.718430/10 
    y_start1, y_end1 = 0.868194/10, (100+0.868194)/10 
    x_start3, x_end3 = 77.593193/10, 101.443398/10 
    y_start3, y_end3 = 0.868194/10, (100+0.868194)/10 

    # bottom contact (5nm):
    x_start2, x_end2 = 0.868194/10, (100+0.868194)/10  
    y_start2, y_end2 = 0.868194/10, 24.718430/10
    x_start4, x_end4 = 0.868194/10, (100+0.868194)/10
    y_start4, y_end4 = 77.593193/10, 101.443398/10

    rect1 = patches.Rectangle((x_start1, y_start1), x_end1 - x_start1, y_end1 - y_start1, linewidth=2, edgecolor='black', facecolor='none', alpha=0.5)
    rect2 = patches.Rectangle((x_start2, y_start2), x_end2 - x_start2, y_end2 - y_start2, linewidth=2, edgecolor='blue', facecolor='none', alpha=0.5)
